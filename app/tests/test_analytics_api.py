...
class TestAnalyticsAPI:
    ...
    async def test_create_analytics_event_success(
        self, client, test_user_and_api_key, sample_analytics_data, async_session
    ):
        ...
        response = await client.post(
            "/api/analytics", json=sample_analytics_data, headers=headers
        )
        ...
        result = await async_session.execute(
            select(AnalyticsEvent).filter(AnalyticsEvent.package_name == "test-package")
        )
    ...
    async def test_create_analytics_event_invalid_api_key(
        self, client, sample_analytics_data
    ):
    ...
    async def test_create_analytics_event_wrong_package(
        self, client, test_user_and_api_key, sample_analytics_data
    ):
        ...
        response = await client.post(
            "/api/analytics", json=wrong_package_data, headers=headers
        )
    ...
    async def test_create_analytics_batch_success(
        ...
        response = await client.post(
            "/api/analytics/batch", json=batch_data, headers=headers
        )
    ...
    async def test_create_analytics_batch_empty(self, client, test_user_and_api_key):
    ...
    async def test_analytics_event_validation_errors(
        self, client, test_user_and_api_key
    ):
        ...
        response = await client.post(
            "/api/analytics", json=invalid_data, headers=headers
        )
        ...
        response = await client.post(
            "/api/analytics", json=invalid_python_data, headers=headers
        )
