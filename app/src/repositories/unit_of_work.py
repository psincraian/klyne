...
from src.repositories.badge_token_repository import BadgeTokenRepository
...
class AbstractUnitOfWork(ABC):
    ...
    badge_tokens: BadgeTokenRepository
...
class SqlAlchemyUnitOfWork(AbstractUnitOfWork):
    ...
    def __init__(self, session: AsyncSession):
        ...
        self.badge_tokens = BadgeTokenRepository(self.session)
