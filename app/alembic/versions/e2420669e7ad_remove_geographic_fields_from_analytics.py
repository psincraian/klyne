...
def downgrade() -> None:
    ...
    op.create_index(
        "idx_analytics_geographic",
        "analytics_events",
        ["package_name", "country_code", "event_timestamp"],
        unique=False,
    )
    op.create_index(
        op.f("ix_analytics_events_country_code"),
        "analytics_events",
        ["country_code"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            "country_code",
            "date",
            name="uq_geographic_stats",
        ),
    )
    op.create_index(
        op.f("ix_geographic_stats_id"), "geographic_stats", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_geographic_stats_package_name"),
        "geographic_stats",
        ["package_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geographic_stats_api_key"),
        "geographic_stats",
        ["api_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geographic_stats_country_code"),
        "geographic_stats",
        ["country_code"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geographic_stats_date"), "geographic_stats", ["date"], unique=False
    )
    op.create_index(
        "idx_geo_stats_package_date",
        "geographic_stats",
        ["package_name", "date"],
        unique=False,
    )
